...
const config: GatsbyConfig = {
  siteMetadata: {
    ...
    siteTitle: `Шорох`,
    siteTitleAlt: `Шорох - Gatsby Starter Portfolio`,
    siteHeadline: `Шорох - Gatsby Theme from @lekoarts`,
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: `Шорох - @lekoarts/gatsby-theme-emilia`,
        short_name: `Шорох`,
